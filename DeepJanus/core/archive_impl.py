...
from HeatmapModule import doDistance
from searchModule import doParamDist
from DeepJanus.core.archive import Archive
from DeepJanus.core.individual import Individual
from DeepJanus.core.misc import closest_elements
...
class SmartArchive(Archive):
            ...
            if candidate.F2 <= 1:
                if len(self) == 0:
                    ...
                    closest_archived, candidate_archived_distance = \
                        closest_elements(self, candidate, lambda a, b: doParamDist(a.params, b.params, self.upper_bound, self.lower_bound))[0]
    ...
    def _int_add(self, candidate):
        self.add(candidate)
        #log.info(f'arcive add {candidate}')
